...
class User implements AdvancedUserInterface, \Serializable
{
     ...
     *      joinColumns={@ORM\JoinColumn(name="iduser", referencedColumnName="iduser", onDelete="cascade")},
     *      inverseJoinColumns={@ORM\JoinColumn(name="idgroup", referencedColumnName="idgroup", onDelete="cascade")}
     * )
     */
    private $groups;
